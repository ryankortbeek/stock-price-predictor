...
# MAIN CODE
# Hyperparameters
hyperparams = HyperParameters(alpha=0.0, batch_size=200, max_epochs=100, k=8, decay=0.05)
...
t_hat_test, _, test_risk = lr_predict(X_test, training_data_best[0], t_test, hyperparams)
